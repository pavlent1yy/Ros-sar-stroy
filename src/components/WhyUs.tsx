      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="mb-10 sm:mb-12 text-center">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto px-2">
            Строим коттеджи, частные дома и коммерческие объекты под ключ с
            полной прозрачностью и контролем качества
          </p>
        </div>
        ...
        <div className="mb-8 sm:mb-10 max-w-3xl mx-auto text-center bg-gradient-to-r from-blue-500/10 via-cyan-500/10 to-blue-500/10 border-2 border-cyan-400 rounded-lg sm:rounded-2xl p-4 sm:p-6 shadow-sm">
          <p className="text-gray-800 font-semibold text-xs sm:text-sm md:text-base leading-relaxed">
            Строительство коттеджей, частных домов, коммерческих и
            промышленных объектов под ключ.{" "}
            <span className="text-blue-600 font-bold">
              Без предоплаты и авансов
            </span>{" "}
            — оплата только за выполненные и принятые этапы работ.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
          {reasons.map((item) => (
            <div
              key={`${item.title}`}
              className="bg-white border-l-4 border-b-4 border-blue-500 rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm hover:shadow-md transition group hover:translate-y-[-4px] will-change-transform"
            >
