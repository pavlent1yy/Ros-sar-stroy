      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="border-l-4 border-cyan-500 pl-4 sm:pl-6 hover:translate-x-1 sm:hover:translate-x-2 transition">
              <p className="font-bold text-gray-900 mb-1 text-sm sm:text-base">💬 Мессенджеры (по номеру телефона)</p>
            ...
            <div className="border-l-4 border-blue-500 pl-4 sm:pl-6 hover:translate-x-1 sm:hover:translate-x-2 transition">
              ...
              <p className="text-gray-600 text-sm sm:text-base break-all">artembrigadier1@gmail.com</p>
            </div>
